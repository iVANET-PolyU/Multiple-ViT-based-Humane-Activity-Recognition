...
class Attention(nn.Module):
    def __init__(self, dim, heads=8, dim_head=183, dropout=0.):
        super().__init__()
...
class ViT(nn.Module):
    def __init__(self, *, num_classes, dim, depth, heads, mlp_dim, pool='cls',
                 dim_head=183, dropout=0., emb_dropout=0.):
        super().__init__()
